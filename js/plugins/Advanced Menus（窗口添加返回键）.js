...
if (back_buttons) {
    ...
    Window_EquipCommand.prototype.addCommand = function(
    ...
    Window_StatusBackButton.prototype = Object.create(
        Window_Command.prototype);
    Window_StatusBackButton.prototype.constructor = Window_StatusBackButton;
    Window_StatusBackButton.prototype.initialize = function(
            x, y) {
